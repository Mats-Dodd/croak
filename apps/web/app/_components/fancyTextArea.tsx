...
const exampleMessages = [
  ...
  },
  {
    ...
    message:
      "For the top 3 most reported issues, can you suggest potential solutions or workarounds?",
  },
];

export default function FancyTextArea({ issue }: { issue: string | null }) {
  ...
  return (
    <div className="stretch mx-auto flex w-full flex-col items-center pt-4 text-custom-light-green">
      <div className="w-full px-4 lg:w-[60ch]">
        {/* Chat messages container with a fixed height and scrollable overflow */}
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      type="submit"
                      size="icon"
                      className="bg-custom-light-green text-primary-foreground hover:bg-custom-mid-green/90"
                    >
                      <CornerDownLeft />
